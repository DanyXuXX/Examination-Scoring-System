...
#include "ui_seechangequestion.h"

SeeChangeQuestion::SeeChangeQuestion(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::SeeChangeQuestion)
{
    ui->setupUi(this);
    this->setWindowTitle(QString("改错题试题"));//改窗口名字
...
SeeChangeQuestion::~SeeChangeQuestion()
{
    delete ui;
}
