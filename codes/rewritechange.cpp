...
#include "ui_rewritechange.h"

RewriteChange::RewriteChange(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::RewriteChange)
{
    ui->setupUi(this);
    this->setWindowTitle("修改改错题试卷");
    ...
    dir.cdUp();//返回上一级路径
    QFile m_file(dir.absolutePath()+"./Test/SeeChangeQuestion.json");
...
RewriteChange::~RewriteChange()
{
    delete ui;
}

void RewriteChange::on_pushButton_finish_clicked()//把修改后的题目再读取进文件
{
